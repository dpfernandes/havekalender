...
export function Footer({ lang }: Props) {
  return (
    <div style={{ marginTop: 36, paddingTop: 20, borderTop: "1px solid #1a2d18" }}>
      <div style={{ fontSize: 11, color: "#2d4a2a", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>
        {lang === "da" ? "Forklaring" : "Legend"}
      </div>
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 24 }}>
        {ALL_ACTIONS.map((key) => (
          <div key={key} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: "#4a6b45" }}>
      ...
      <div style={{ padding: "12px 16px", background: "#0a1508", borderRadius: 10, border: "1px solid #1a2d18" }}>
        <div style={{ fontSize: 11, color: "#2d4a2a", lineHeight: 1.6 }}>
          {lang === "da"
